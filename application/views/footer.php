        ...
        <div class="col-lg-3 col-md-6">
          <div class="widget footer-widget">
            ...
            <ul class="footer-menu">
              <li><a href="product1">Qwik Connect</a></li>
              <li><a href="product2">Qwik Box</a></li>
              <li><a href="product3">Qwik Virt</a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="widget footer-widget">
            ...
            <ul class="footer-menu">
              <li><a href="industry1">Education</a></li>
              <li><a href="industry2">Incubator</a></li>
              <li><a href="industry3">ISP's</a></li>
              <li><a href="industry4">Data Center</a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
...
<script src="<?php echo base_url(); ?>/dependencies/countUp/countUp.min.js"></script>
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&#038;ver=2.1.6">
</script> -->
